...
if __name__ == '__main__':
    ...
    # indices = np.argwhere(scene_ref.data)
    # if indices.size == 0:
    #     print('didnt work to extract coordinates')
    #     print('unique values in reference map:')
    #     print(np.unique(scene_ref))
    #     print(median_lat)
    #     raise ValueError("scene_ref.data has no non-zero elements.")
