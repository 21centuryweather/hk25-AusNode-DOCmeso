...
def calculate_metric(data_objects):
    ...
    # == create metric ==
    # -- check data --
    da, process_requestd, count = data_objects # , da2
    # print(da2)
    # exit()
    ...
    for i, timestep in enumerate(da.time):
        ...
        if plot:
            ...
            da_plot = ((da_timestep - spatial_mean))  # anomalies from the spatial-mean
            ...
            # -- save figure --
            folder = f'/scratch/nf33/cb4968/icon/plots/imerg_snapshots'
